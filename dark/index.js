...
const vcard = 'BEGIN:VCARD\n' //
            ...
            + 'ORG:Creator EREN;\n' //
            + 'TEL;type=CELL;type=VOICE;waid=551999897566:+551999897566\n' //
            + 'END:VCARD'
prefix = '/'
blocked = []
...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["551999897566@s.whatsapp.net","551999897566@s.whatsapp.net","551999897566@s.whatsapp.net"]
			const mod = [ownerNumber,"551999897566@s.whatsapp.net","551999897566@s.whatsapp.net","551999897566@s.whatsapp.net"]
			const adminbotnumber = ["551999897566@s.whatsapp.net","551999897566@s.whatsapp.net","551999897566@s.whatsapp.net"]
			const frendsowner = ["551999897566@s.whatsapp.net","551999897566@s.whatsapp.net","551999897566@s.whatsapp.net"]
			const premium = ["551999897566@s.whatsapp.net","551999897566@s.whatsapp.net","551999897566@s.whatsapp.net"]
...
if (isBanned) return reply(mess.only.benned)    
               ...
               client.reply(from, `Waalaikumsalam wr.wb${pushname}:)`)
				...
				if (!isUser) return reply(mess.only.userB)
                    ...
                    client.sendMessage('551999897566@s.whatsapp.net', options, text, {quoted: mek})
