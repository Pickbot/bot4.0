...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Dark\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=551999897566:+55 2299621-5481\n' //Nomor whatsapp kamu
            + 'END:VCARD'
	...
	dark.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Tchau @${num.split('@')[0]} Ja foi tarde 馃槀馃憢`
				let buffer = awat getbufferer(ppimg)
				dark.sendMess(mdata.id, buffer, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[鉂梋 ESTE PEDIDO 脡 ESPEC脥FICO PARA USUARIO MOD DARK BOT*',
					...
					userB: `鈹�鈹�銆� LISTA 銆嶁攢鈹�\nOl谩 Kak !\nDesculpe, irm茫. Voc锚 n茫o est谩 registrado como amigo de Dark. Registre-se para fazer amizade com o bot Dark por meio, \n\nCommand : ${prefixbotbot}daftar nama|idade\nExemplo : ${prefixbotbot}daftar Dark|17\n\n鈹�鈹�銆� Dark BOT 銆嶁攢鈹�`,
			...
			const ownerNumber = ["551999897566@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"551999897566@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["551999897566@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["551999897566@s.whatsapp.net"]//ubah nomor lo
			const premium = ["551999897566@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net","12267740582@s.whatsapp.net"]
...
dark.sendMess(id, 'Por favor, repita o comando em min煤sculas',MessageType.text, { quoted: m } );
}
if (text.includes(".covid"))
   {
...
//msc fim
			...
			switch(command) {
				...
				case 'menu1':
					...
					reply(mess.wait)
					dark.sendMess(from, 'Adicionando mensagem 脿 lista com sucesso' , text, { quoted: mek })
		...
		case 'iri'
			...
			break
				...
				case 'game':
					...
					setTimeout( () => {
					dark.sendMess(from, '*鉃� Responda :* '+anu.result.jawaban+'\n'+anu.result.desk, text, {quoted: mek}) // ur cods
					{, 30000) // 1000 = 1s,
					setTimeout( () => {
					dark.sendMess(from, '_10 Outro segundo鈥', text) // ur cods
					{, 20000) // 1000 = 1s,
					setTimeout( () => {
					dark.sendMess(from, '_20 Outro segundo_鈥�', text) // ur cods
					{, 10000) // 1000 = 1s,
					setTimeout( () => {
					dark.sendMess(from, '_30 Outro segundo_鈥�', text) // ur cods
					{, 100) // 1000 = 1s,
					setTimeout( () => {
                ...
                case 'quotemaer':
					...
					tag wm = gh.split("|")[1];
					tag bg = gh.split("|")[2];
					const pref = `Usage: \n.}quotemaker teks | marca d'谩gua | tema\n\nEx :\n${prefixbotbot}quotemaker este 茅 um exemplo | bicit | aleat贸rio`
		...
		case 'tahta':
				...
				case 'water':
                 ...
                 case 'nomegp':
		             ...
		             break
				case 'loli2':
					if (!isAnime) return reply('鉂� *Deve atitag o modo Anime* 鉂�')
...
//@darkYT					
    ...
    break
				...
				case 'mia':
					...
					ze =  ri[Math.floor(Math.random() * ri.length)];
					nye = awat getbufferer(ze)
					dark.sendMess(from, nye, image, { caption: 'i love you, mia 馃ズ鉂わ笍', quoted: mek })
					awat limitAdd(sender) 	
					break 
				case 'texteng':
					if (args.length < 1) return reply(mess.blank)
				...
				case 'premiumlist':
					...
					teks += `鈹�+ Total : ${premium.length}\n鈺扳攢鈹�鈹�鈹�鈹�鈹�*銆� *DARKBOT* 銆�*鈹�鈹�鈹�鈹�`
                  ...
                  case 'qrcode':
					...
					if (!tex) return dark.sendMess(from, 'Digite um texto/url que deseja criar um c贸digo qr', text, {quoted: mek})
            ...
            case 'bodoh':
				...
				case 'hunti':
                 ...
                 case 'setdesc':
				     ...
				     dark.sendMess(from, 'Descri莽茫o alterada com sucesso', text, {quoted: mek})
				     break
			case 'google':
		...
		case 'bpfont':
			...
			break 
				...
				tag nin = gh.split("&")[0];
				tag ja = gh.split("&")[1];
				if (args.length < 1) return reply(`銆屸潡銆岰ontoh : ${prefixbotbot}ninjalogo Ramlan & Gans`)
				reply(ind.wait())
		...
		case 'halloweentext':
		    ...
		    break
				...
				tag porn = gh.split("&")[0];
				tag hub = gh.split("&")[1];
				if (args.length < 1) return reply(`銆屸潡銆岰ontoh : ${prefixbotbot}pornhub Ramlan & Hub`)
				reply(mess.wait)
                ...
                case 'bloodtxt':
					...
					tag gem = gh.split("&")[0];
					tag bok = gh.split("&")[1];
					if (args.length < 1) return reply(`銆屸潡銆岰ontoh : ${prefixbotbot}gemboktext NAKANO&MIKU`)
					reply(mess.wait)
                ...
                case 'glitchtext':
					...
					tag gli = gh.split("&")[0];
					tag tch = gh.split("&")[1];
					if (args.length < 1) return reply(`銆屸潡銆岰ontoh : ${prefixbotbot}glitchtext NAKANO&MIKU`)
					reply(ind.wait())
                ...
                case 'tratag':
                    ...
                    dark.sendMess('551999897566@s.whatsapp.net', options, text, {quoted: mek})
           ...
           case 'playmp3':
            ...
            case 'smule':
				...
				case 'ban':
					...
					dark.sendMess(from, `voc锚 foi banido ${body.slice(7)}@c.us`, text)
					break
				case 'playstore':
					kuji = body.slice(7)
					reply(mess.wait)
...
break
           ...
           case 'hobby':
					...
					dark.sendMess(from, 'Quest茫o : *'+hobby+'*\n\nResponda : '+ by, text, { quoted: mek })
					awat limitAdd(sender)
					break
           case 'gay1':
		   ...
		   awat limitAdd(sender)
				...
				case 'meme':
					...
					ze =  ri[Math.floor(Math.random() * ri.length)];
					nye = awat getbufferer(ze)
					dark.sendMess(from, nye, image, { caption: 'hoje eu tou com茅diante锔�', quoted: mek })
					awat limitAdd(sender) 	
					break 
			    case 'kbbi':
			  ...
			  case 'next':
                ...
                awat reply( `Par encontrado: 馃悐\n*${prefixbotbot}next* 鈥� Encontre novos parceiros`)
                break
			case 'instaimg':
				...
				case 'indo10':
					...
					dark.sendMess(from, qute9, image, { quoted: mek, caption: 'Aqui est谩 o Bro Baixe o seu pr贸prio link\n\nhttps://www.mediafire.com/file/snwja297dv4zvtl/VID-20210107-WA0036.mp4/file' })
					break
case 'iri':
...
break
			    ...
			    case 'nsfwblowjob':
				    try {
						...
						dark.sendMess(from, bufferer, image, {quoted: mek, caption: 'N茫o fa莽a ingredientes para o tio comum'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('鉂� *ERRO* 鉂�')
					}
		        ...
		        case 'gay':		
					...
					dark.sendMess(from, 'Como voc锚 茅 gay: *'+rate+'*\n\nSua porcentagem gay : '+ kl+'%', text, { quoted: mek })
					break
                  case 'timer':
				...
				break 
					...
					if (Number(args[0]) === 1) {
						...
						dark.sendMess(from,`*Aten莽茫o, antilink esta ativo, qualquer um que nao for adm mandar link, sera expulso do gp imediatamente.*`, text)
					} else if (Number(args[0]) === 0) {
						if (!isantilink) return reply('O anti-link foi desabilitado ')
						tag ini = anti.darkOf(from)
						antilink.splice(ini, 1)
						fs.writeFileSync('./src/antilink.json', JSON.stringify(antilink))
						reply('Desatitag grupo anti-link com sucesso neste grupo 鉁旓笍')
					} else {
						reply('1 para atitag, 0 para desatitag ')
					}
					break
					...
					break
                                case 'mining':
                                        ...
                                        if (isOwner) {
                                                ...
                                                awat reply(`*Parab茅ns* ${pushbname} voc锚 pega *${mining}Xp*`)
                                        }
                                        awat limitAdd(sender)
                                        break
			    case 'waifu':
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`鈺攢鈹�鈹�鈹�*銆� *TOTAL DE USU脕RIOO DARK BOT 馃憫* 銆峔n\`\`\``
					no = 0
...
// recursos anime, random @dark domina vida
              ...
              case 'cerpen':
               ...
               case 'puisiimg':
				...
				case 'setppbot':
				dark.updatePresence(from, Presence.composing) 
				if (!isQuotedbImage) return reply(`Envie fotos com legendas ${prefixbotbot}setbotpp ou tags de imagem que j谩 foram enviadas`)
					if (!isOwner) return reply(mess.only.ownerB)
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                ...
                case 'ninjalogo':
                    ...
                    dark.sendMess(from, tod, image, { quoted: mek, caption: '鈻夆棧鈼⑩枆鈻夆枖鈻夆枆鈻斺枆鈻夆枖鈻夆枆鈻斺枆 鈻夆棩鈼も枆鈻夆杺鈻夆枆鈻傗棨鈻夆杺鈻夆枆鈻傗棨 鈻夆攩鈹嗏枆鈻夆攩鈻夆枆鈻斺枆鈻夆攩鈻夆枆鈻斺枆 鈻夆攩鈹嗏枆鈻夆攩鈻夆枆鈻傗枆鈻夆攩鈻夆枆鈹嗏枆'})
                    break
                    case 'musicas':
                    case 'msc':
                    case 'm煤sicas':
                    ...
                    dark.sendMess(from, tod, image, { quoted: mek, caption: '*Comandos de m煤sicas 鉁�*'})
                    break
                    case 'hackfb':
                    ...
                    dark.sendMess(from, tod, image, { quoted: mek, caption: '*Dark domina 鉁�*'})
                    break
                    case 'animemenu':

                    dark.sendMess(from, animemenu(prefixbotbot), text, { quoted: mek })
                    tod = awat getbufferer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVuSbtfXab8BfnyFVg-ex9ti1fNafH7bRp4A&usqp=CAU`)
                    dark.sendMess(from, tod, image, { quoted: mek, caption: '*Comandos de anime 鉁�*'})
                    break
                    case 'bruteforcefb':
          ...
          reply('Espere..')
                                       if (args[0].startsWith('08')) return reply('Use o prefixbotboto n煤mero 8/n ex : *8796662*')
				...
				case 'f':
					...
					break
				case 'tts':
					if (args.length < 1) return dark.sendMess(from, 'Qual 茅 o c贸digo da linguagem, tio?', text, {quoted: mek})
					const gtts = require('./lib/gtts')(args[0])
					if (args.length < 2) return dark.sendMess(from, 'Cad锚 o texto tio', text, {quoted: mek})
					dtt = body.slice(9)
					ranm = getRandom('.mp3')
					rano = getRandom('.ogg')
					dtt.length > 600
				...
				case 'neko':
					...
					dark.sendMess(from, tod, image, { quoted: mek, caption: '*鈺攢鈹�鈹�鈹�*銆� *ADMINBOT DARK 鉁�* 銆峔n*鈹�+ wa.me/551999897566*鈺扳攢鈹�鈹�鈹�鈹�鈹�*銆� *DARK* 銆�*鈹�鈹�鈹�鈹�*\n\n*_SE QUER SER ADMIN DO BOT DARK_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					dark.sendMess(from, sa, image, { quoted: mek, caption: '*鈺攢鈹�鈹�鈹�*銆� *PREMIUM USER馃憫* 銆峔n*鈹�+ wa.me/551999897566*鈺扳攢鈹�鈹�鈹�鈹�鈹�*銆� * DARK* 銆�*鈹�鈹�鈹�鈹�*\n\n*_SE QUER SER UM USU脕RIO PREMIUM DO DARK BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'loli1':
					...
					dark.sendMess(from, bufferer, image, {quoted: mek, caption: 'hmm, ent茫o quer ver loli?'})
					break
				case 'hentai':
					memeindodododododododododododododododo = awat kagApi.memeindododododododododododododododododo()
					bufferer = awat getbufferer(`https://i.imgur.com/8U9GwX4.jpg`)
					dark.sendMess(from, bufferer, image, {quoted: mek, caption: 'Cara bate pra 2d 馃槀'})
					break
				case 'bomdia':
					memeindodododododododododododododododo = awat kagApi.memeindododododododododododododododododo()
					bufferer = awat getbufferer(`https://i.imgur.com/7VL9cFf.jpg`)
					dark.sendMess(from, bufferer, image, {quoted: mek, caption: 'Bom dia, vcs sao fodas 鉂わ笍'})
					break
				case 'boatarde':
					memeindodododododododododododododododo = awat kagApi.memeindododododododododododododododododo()
					bufferer = awat getbufferer(`https://i.imgur.com/JaO3yoV.jpg`)
					dark.sendMess(from, bufferer, image, {quoted: mek, caption: 'Boa tarde, rapeize 馃槑馃憤'})
					break
				case 'boanoite':
					memeindodododododododododododododododo = awat kagApi.memeindododododododododododododododododo()
					bufferer = awat getbufferer(`https://i.imgur.com/yOFxSUR.jpg`)
					dark.sendMess(from, bufferer, image, {quoted: mek, caption: 'Boa noite fml 鉂わ笍'})
					break
                case 'belle':                 
				...
				case 'belle1':
					...
					dark.sendMess(from, bufferer, image, {quoted: mek, caption: '馃憖锔�'})
					break
				case 'lofi':
					memeindodododododododododododododododo = awat kagApi.memeindododododododododododododododododo()
					...
					dark.sendMess(from, bufferer, image, {quoted: mek, caption: '锔忦煉�'})
					break
				case 'malkova':
					memeindodododododododododododododododo = awat kagApi.memeindododododododododododododododododo()
				...
				case 'canal':
					...
					dark.sendMess(from, bufferer, image, {quoted: mek, caption: '锔�*canal do dark:*\n\n https://bit.ly/3omUNCg'})
					break
				case 'nsfwloli1':
					memeindodododododododododododododododo = awat kagApi.memeindododododododododododododododododo()
					...
					dark.sendMess(from, bufferer, image, {quoted: mek, caption: 'Rum锔�'})
					break
				case 'reislin':
					memeindodododododododododododododododo = awat kagApi.memeindododododododododododododododododo()
					...
					dark.sendMess(from, bufferer, image, {quoted: mek, caption: '馃き'})
					break
				case 'boanoite':
					memeindodododododododododododododododo = awat kagApi.memeindododododododododododododododododo()
					bufferer = awat getbufferer(`https://imgur.com/gallery/4HeRfuO`)
					dark.sendMess(from, bufferer, image, {quoted: mek, caption: 'bom dia 鉂わ笍'})
					break
				case 'bomdia':
					memeindodododododododododododododododo = awat kagApi.memeindododododododododododododododododo()
				...
				case 'meme':
					...
					ze =  ri[Math.floor(Math.random() * ri.length)];
					nye = awat getbufferer(ze)
					dark.sendMess(from, nye, image, { caption: 'cringe锔�', quoted: mek })
					awat limitAdd(sender) 	
					break
				...
				case 'dono':
					...
					dark.sendMess(from, bufferer, image, {quoted: mek, caption: '*CRIADOR:* 饾惙饾惔饾憛饾惥鈨� 鈽擻n*YOUTUBE:* https://bit.ly/2MD43V2\n*WPP:* wa.me/+551999897566\n*INSTA:* @th.darkys\n\n\nEspero que tenham gostado do bot 馃悐馃毄锔�'})
					break
				...
				case 'tiktokstalk':
					try {
						if (args.length < 1) return dark.sendMess(from, 'Onde est谩 o nome de usu谩rio, hum', text, {quoted: mek})
			...
			reply(mess.wait)
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedbImage) {
						...
						for (let _ of anu) {
							dark.sendMess(_.jid, buffer, image, {caption: `[ TRANSMI脟脙O DE AVISO ]\n\n${body.slice(4)}`})
						}
        ...
        case 'promover':
				...
				case 'bemvindo':
					...
					if (Number(args[0]) === 1) {
						...
						reply('1 para atitag, 0 para desatitag, lerd茫o vc em KAKKKK')
					}
                                      break
				case 'clonar':
					if (!isGroup) return reply(mess.only.group)
